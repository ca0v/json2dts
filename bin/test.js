...
describe("reduce", () => {
    it("simple reduce", () => {
        ...
        ]))).deep.equal([{ a: [1] }], "simple reduce a:[1]");
        const o1 = {
            n: 1,
            a: [2],
        };
...
describe("object->typing", () => {
    ...
    it("moderate", () => {
        expect(log(full({
            ...
            b: [1, !1],
            c: [{ d: 1 }, { d: !1 }],
        }))).equal("{a:number,b:Array<boolean|number>,c:Array<{d:boolean|number}>}");
    });
    it("advanced", () => {
        expect(log(full({
            a: 1,
        ...
        }))).equal("{a:number,b:Array<boolean|number|string>,c:Array<{d:boolean|number}>}");
    });
});
